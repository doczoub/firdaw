                        ...
                        <b-collapse class="collapse navbar-collapse" id="navbarSupportedContent" is-nav>
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item p-relative"><a href="#" class="nav-link">Boutique <i class="fas fa-chevron-down"></i></a>
                                  ...
                                  <li class="nav-item p-relative"><a href="#" class="nav-link">Categories <i class="fas fa-chevron-down"></i></a>
                                    <ul class="dropdown-menu" >
                                        <li class="nav-item" v-for="categorie in categories_domain" :key="categorie.id">
                                            <nuxt-link to="`/categories/${categorie.id}`" class="nav-link">{{categorie.name}}</nuxt-link>
                                            </li>
                                    </ul>
                                </li>
