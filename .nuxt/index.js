...
import nuxt_plugin_bootstrapvue_3a73c5b5 from 'nuxt_plugin_bootstrapvue_3a73c5b5' // Source: .\\bootstrap-vue.js (mode: 'all')
import nuxt_plugin_axios_c1b464f4 from 'nuxt_plugin_axios_c1b464f4' // Source: .\\axios.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"htmlAttrs":{"lang":"en"},"title":"Bolster - eCommerce Nuxt.js\u002FVue.js Template","meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":"Bolster is a clean and modern purse Vue Nuxt.js eCommerce template. This is built on Vue.js, Nuxt.js, Vuex, Firebase, Sass and Bootstrap 4. Bolster has included with an easy checkout feature. It has responsive beautiful design layouts with amazing Retina Ready visual UX\u002F UI experience."}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.ico"}],"style":[],"script":[]},
  ...
  if (typeof nuxt_plugin_bootstrapvue_3a73c5b5 === 'function') {
    await nuxt_plugin_bootstrapvue_3a73c5b5(app.context, inject)
  }

  if (typeof nuxt_plugin_axios_c1b464f4 === 'function') {
    await nuxt_plugin_axios_c1b464f4(app.context, inject)
  }
