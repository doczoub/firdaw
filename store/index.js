...
const mutations = {
    ...
    //    let recentProducts = state.products = state.latestProducts;
...
const actions = {
    ...
    //     axios.get("https://www.affairez.com/apistock/api/get/products").then((produit) =>{
    //         commit('GET_PRODUCT', produit.data)
